...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage their marketing, sales, customer service, and content management needs through a unified suite of tools.
...
2. Note that while HubSpot offers a free CRM tier, certain API features and higher rate limits may require a Professional or Enterprise plan subscription.

### Step 2: Generate an API Access Token

HubSpot uses private apps to generate access tokens for API authentication. Follow these steps to create one:
...
7. Click **Create app** in the top right corner, then review the permissions and click **Continue creating**.
...
2. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Illustrates creating associations and retrieving existing associations between CRM objects.
