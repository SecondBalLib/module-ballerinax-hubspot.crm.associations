...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through a unified suite of tools designed to grow better.
...
8. Once created, navigate to the Access token section and click Show token to reveal your access token.
...
2. [Create read associations](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations/tree/main/examples/create-read-associations) - Illustrates creating associations and retrieving associated records from HubSpot CRM.