...
public type BatchInputPublicDefaultAssociationMultiPost record {
    # Array of default association requests to process in batch.
...
public type BatchInputPublicAssociationMultiArchive record {
    # Array of association archive requests to process in batch.
...
public type PublicAssociationMultiPost record {
    # Array of association type specifications for the relationship.
...
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of labeled association results between object pairs.
...
# Request object for fetching associations for a specific object in batch operations.
