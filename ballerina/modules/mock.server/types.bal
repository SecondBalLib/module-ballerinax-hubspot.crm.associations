...
# Represents multiple associations with labels between CRM objects.
...
# Request object for creating associations between CRM objects.
...
# Response containing batch results for labeled associations between object pairs.
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of successfully processed labeled association pairs.
...
public type BatchResponsePublicDefaultAssociation record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully created default association objects.
...
public type BatchResponsePublicAssociationMultiWithLabel record {
    ...
    # An object containing relevant links related to the batch request
    record {|string...;|} links?;
    # Array of successfully processed association objects with their labels.
...
# Response object for batch operations that do not return data, only status information.
