...
public type ReportCreationResponse record {
    ...
    # ID of the user
    int:Signed32 userId;
    # Object representing a date and time value with timezone information.
    DateTime enqueueTime;
};

# Association object linking a source object to multiple targets with labels.
...
# Batch input for creating multiple default associations.
public type BatchInputPublicDefaultAssociationMultiPost record {
    # Array of default association creation requests to process.
    PublicDefaultAssociationMultiPost[] inputs;
};

# Batch input for archiving multiple associations.
public type BatchInputPublicAssociationMultiArchive record {
    # Array of association archive requests to process.
...
public type MultiAssociatedObjectWithLabel record {
    # Array of association types with their corresponding labels.
...
# Batch response containing association labels between object pairs.
public type BatchResponseLabelsBetweenObjectPair record {
    ...
    record {|string...;|} links?;
    # Array of association labels between object pairs.
...
public type PublicAssociationMultiArchive record {
    # Contains the Id of a Public Object
    PublicObjectId 'from;
    # Array of target object identifiers to remove associations from.
    PublicObjectId[] to;
};
...
public type BatchInputPublicAssociationMultiPost record {
    # Array of association creation requests to process in batch.
...
# Batch request container for fetching multiple association sets.
...
# Response object for batch operations containing labeled associations with processing status.
...
# Paginated response containing labeled multi-associations with forward paging support.
public type CollectionResponseMultiAssociatedObjectWithLabelForwardPaging record {
    # Pagination object for forward navigation through results.
    ForwardPaging paging?;
    # Array of multi-associated objects with their labels.
...
# Response object for batch operations that do not return data, only status.
